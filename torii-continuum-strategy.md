...
## Sovereign Bot Stack (GENESIS-1 shipped v0.2.78-alpha; principle architecture + constitution genesis-1.1.0 shipped v0.2.81-alpha; MEMORY-1 shipped v0.2.82-alpha; first-run activation MEMORY-ACTIVATION-1 shipped v0.2.84-alpha; LoRA/RAG gated)
