...
**Current version:** v0.2.37-alpha (onboarding preview v0.1.18-preview)
**Currently deployed server version:** v0.2.29-alpha (deployed to the SHC VPS on a Node 22.23.1 host). **v0.2.30-alpha through v0.2.37-alpha are code+PR only — not yet deployed.**
