...
- `onboarding-client.js` - step-1 live auth client (v0.1.14). Self-contained,
  ...
  reload (`isSessionValid`/`restoreSession`, fail closed) and the character
  loader retry policy (`nextLoadAttempt`).
